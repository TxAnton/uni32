...
//qt_normal*uoffset,0.0f
//    TexCoord = qt_TexC.xy;
    vColor = qt_Color.rgb;
    offset = uoffset;
    normal = (qt_ModelViewProjectionMatrix * vec4(qt_normal,0)).xyz;
    lightsource = qt_lightsource;
    position = qt_ModelViewProjectionMatrix * (qt_Vertex);
